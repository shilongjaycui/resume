...
### DevOps Engineer <time> Sep 2022 – May 2024 </time>
...
- Safeguarded the data science team's developmental & operational excellence by resolving **30+** MLOps support tickets
...
- Provided company-wide access to up-to-date vector embeddings at all times by building and deploying two self-updating data pipelines (Python, Databricks, [Dagster](https://dagster.io/), Hugging Face, [Pinecone](https://www.pinecone.io/))
- Troubleshooted and resolved **5+** AWS deployment issues that involve Elastic Container Service (ECS), Elastic Load Balancer (ELB), Route 53, Virtual Private Cloud (VPC), and CloudFormation
- Reduced tech debt for all data teams by **50%** by migrating legacy services from Bitbucket to GitHub
- Created, managed, and provisioned AWS resources programmatically for **10+** cross-functional projects before passing the AWS Certified Cloud Practitioner exam (Python, AWS CLI, AWS SDK, AWS CDK)
